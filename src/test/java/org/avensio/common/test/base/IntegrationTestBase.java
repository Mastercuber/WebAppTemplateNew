...
import org.avensio.common.spring.config.RedisConfig;
import org.avensio.common.spring.config.WebSocketConfig;
import org.avensio.common.spring.context.ApplicationContext;
import org.avensio.common.test.application.IntegrationTestApplication;
import org.avensio.common.test.config.IntegrationTestConfig;
...
@ContextConfiguration(locations = {"classpath:/test/BeanConfig.xml"}, classes = {ContextConfig.class, IntegrationTestApplication.class, IntegrationTestConfig.class, RedisConfig.class, WebSocketConfig.class})
public class IntegrationTestBase extends TestBase {
    ...
    public void setUp() throws IOException {
        if (!isDone) {
            ...
            RestAssured.port = ApplicationContext.getPort();
