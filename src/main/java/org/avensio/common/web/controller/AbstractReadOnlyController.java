...
import org.avensio.common.service.IRawService;
import org.avensio.common.web.RestPreconditions;
import org.avensio.common.web.exception.MyResourceNotFoundException;
...
public abstract class AbstractReadOnlyController<T extends IEntity> {
    ...
    /**
     * Counts all resources for a type(Privileges, Roles, Permissions etc.) in the system
     * @return
     */
